...
class Project {
  ...
  int _build() {
    ...
    var compile = new CommandLineTask(() => _compiler.run(_compilerArgs.arguments, workingDirectory : PATH_TO_PROJECT));
    compile.before = 'Compile...';
    compile.success = 'Compilation succesful.';
    compile.fail = 'Compilation failed.';
    tasks.add(compile);
    var link = new CommandLineTask(() => _linker.run(_linkerArgs.arguments, workingDirectory : PATH_TO_PROJECT));
    link.before = 'Link...';
    ...
    _clean(PATH_TO_PROJECT, _unusedFileExtensions);
    return 0;
  }
